// app/merchandise/[slug]/ProductClient.tsx
"use client";
    ...
    const fetchProduct = async () => {
      try {
        const response = await fetch(
          `https://swarnakriti-api.technolitics.com/api/v1/product/one/${productId}`
        );
        ...
        <div className="lg:flex lg:gap-8 lg:m-8 lg:mb-0 lg:pb-20">
          ...
          <div className="lg:w-[53%] p-5 lg:pt-0">
            ...
            <div className="pt-6">
              ...
              <div className="border-b border-gray-300 pt-4 pb-5"></div>
              <p className="uppercase text-[14px] font-[700] text-[#282c3f] pt-5 pb-2">
                Delivery options
              </p>
              <p className="text-[14px] font-[700] text-[#282c3f] pt-5 pb-2">
                Get it by Wed, Mar 10
              </p>
              <p className="text-[14px] font-[700] text-[#282c3f] pt-5 pb-2">
                Pay on delivery available
              </p>
              <p className="text-[14px] font-[700] text-[#282c3f] pt-5 pb-2">
                Easy 14 days return and exchange
              </p>
              <p className="text-[#282c3f] font-[400] py-4">100% Original Products</p>
              <p className="uppercase text-[14px] font-[700] text-[#282c3f] pt-5 pb-2">
                Best offers
              </p>
              <p className="text-[#282c3f] font-[400] py-2">
